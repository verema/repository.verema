...
Base = 'https://dl.dropbox.com/s/d85nwcny9sls8u8/ADDON%20KODI%20GASHO%20INICIO.txt' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.kodigasho') #    modificar("el nombre de tu addons")
